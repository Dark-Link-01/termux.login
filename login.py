# UBAH SEMUA KARAKTER YG BERADA DI DALAM TANDA BINTANG (*...*)
...
def berhasil():
        ...
        tampil ('         [][][][][][][][][][][][][][][][][][][][]')
	os.system('sleep 1')
	tampil ('''              ADMIN    >\rh *MASUKAN NAMA*''') ###### <<-- CEK
        os.system('sleep 1')
        tampil ('              USERNAME >\rh *TERSERAH DIISI APA*')   ### <<-- CEK
	os.system('sleep 1')
	tampil ('              ID       >\rh *TERSERAH DIISI APA*')   ### <<-
	os.system('sleep 1')
        tampil ('         [][][][][][][][][][][][][][][][][][][][]')
	os.system('sleep 3')
        os.system('clear')
...
\033[31;1m==========================================================\033[32;1m''')
                        ...
                        if sandi == '*MASUKAN USERNAME*' and user == '*MASUKAN SANDI*'
#     CEK BARIS DI ATAS':
                                berhasil()
                        else:
				salah()
